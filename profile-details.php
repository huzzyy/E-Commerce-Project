...
<section  class="menu">
	<nav class="navbar navigation">
        ...
        <div class = "products">
            <div class = "container">
                <h1 class = "lg-title">Special Kitchen Ware With Offers</h1>
                ...
                <div class = "product-items">
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitchen01.jpg" alt = "product image">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Stainless Steel Cocktail Shaker Set Bar Tool Set">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">Stainless Steel Cocktail Shaker Set Bar Tool Set   </a>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitchen2.jpg" alt = "product image" height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Gaggia RI9380/49 Classic Pro Espresso Machine">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">Gaggia RI9380/49 Classic Pro Espresso Machine</a>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitchen3.jpg" alt = "product image">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Kitchen Utensil Set 24 Nylon and Stainless Steel Utensil Set">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">
                                Kitchen Utensil Set 24 Nylon and Stainless Steel Utensil Set </a>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitchen4.jpg" alt = "product image">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="KMAT Kitchen Mat [2 PCS] Cushioned Anti-Fatigue Kitchen Rug">
...
KMAT Kitchen Mat [2 PCS] Cushioned Anti-Fatigue Kitchen Rug</a>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitchen5.jpg" alt = "product image" height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Mixing Bowls with Airtight Lids, 20 piece Stainless Steel Metal Nesting Bowls">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">Mixing Bowls with Airtight Lids, 20 piece Stainless Steel Metal Nesting Bowls</a>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kitc6.jpg" alt = "product image" height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="OUII Flat Top Griddle Accessories Set for Blackstone and Camp Chef Griddle">
                                <input type="hidden" name="Price" value=" 133.00$">
</form>
                            </div>
                        </div>
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">OUII Flat Top Griddle Accessories Set for Blackstone </a>
                            <p class = "product-price">$ 150.00</p>
                    ...
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kit7.jpg" alt = "product image"height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Airtight Food Storage Containers">
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">
                                Airtight Food Storage Containers</a>
                            <p class = "product-price">$ 100.00</p>
                            <p class = "product-price">$ 61.00</p>
                        </div>
                    </div>
                    <!-- end of single product -->
                    <!-- single product -->
                    <div class = "product">
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kit8.jpg" alt = "product image" height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="Dish Drying Rack, Romision 2 Tier Dish Rack Drainboard Set">
                                <input type="hidden" name="Price" value=" 133.00$">
</form>
                            </div>
                        </div>
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">Dish Drying Rack, Romision 2 Tie Set</a>
                            <p class = "product-price">$ 150.00</p>
                            <p class = "product-price">$ 133.00</p>
                        </div>
                    ...
                    <!-- end of single product -->
                        ...
                        <form action="php/managecart.php" method="POST">
                            <div class = "product-img">
                                <img src = "images/kitchen/kit.jpg" alt = "product image" height="200px">
                            </div>
                            <div class = "product-btns">
                            <button type="submit" name="Add_To_Cart" class="btn btn-main">Add To Cart</a></button>
                                <input type="hidden" name="Item_Name" value="18-Piece Kitchen Dinnerware Set, Plates, Dishes, Bowls, Service for 6">
                                <input type="hidden" name="Price" value=" 100.00$">
</form>
                            </div>
                        </div>
                        ...
                        <div class = "product-info">
                            ...
                            <a href = "#" class = "product-name">18-Piece Kitchen Dinnerware Set, Plates, Dishes, Bowls, Service for 6</a>
                            <p class = "product-price">$ 150.00</p>
                            <p class = "product-price">$ 100.00</p>
                        </div>
